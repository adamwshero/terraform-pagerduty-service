...
```
## Terraform Example w/CloudWatch & SNS Integration + Maintenance Windows
```
module "pagerduty-service" {
  source = "git@github.com:adamwshero/terraform-pagerduty-service.git//.?ref=1.1.0"
...
```
## Complete Terraform Example w/CloudWatch & SNS Integration + Maintenance Windows + Scheduled Actions || Incident Urgency Rules (NOT BOTH) + Slack Extension
```
module "pagerduty-service" {
  source = "git@github.com:adamwshero/terraform-pagerduty-service.git//.?ref=1.1.0"
